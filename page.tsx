      ...
      <header className="bg-white shadow-sm">
        <div className="container mx-auto px-4 py-4 flex justify-between items-center">
          ...
          <nav className="hidden md:flex space-x-6">
            <Link href="/" className="text-gray-600 hover:text-[#1a73e8]">Home</Link>
            <Link href="#how-it-works" className="text-gray-600 hover:text-[#1a73e8]">How It Works</Link>
            <Link href="/locations" className="text-gray-600 hover:text-[#1a73e8]">Locations</Link>
            <Link href="#" className="text-gray-600 hover:text-[#1a73e8]">Contact</Link>
            </nav>
          ...
          <div className="container mx-auto px-4">
            ...
            <div className="max-w-md mx-auto bg-white rounded-lg shadow-md overflow-hidden">
              <div className="bg-[#1a73e8] text-white p-6 text-center">
                ...
                <p className="text-4xl font-bold">₹399<span className="text-xl">/day</span></p>
              </div>
              <div className="p-6">
        ...
        <div className="container mx-auto px-4">
          <div className="grid grid-cols-1 md:grid-cols-4 gap-8">
            ...
            <div>
              ...
              <p className="text-sm">Email: contact@storoo.in</p>
              <p className="text-sm">Phone: +91 8360805343</p>
            </div>
            <div>
