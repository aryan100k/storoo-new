      ...
      <header className="bg-white shadow-sm">
        <div className="container mx-auto px-4 py-4 flex justify-between items-center">
          ...
          <nav className="hidden md:flex space-x-6">
            <Link href="/" className="text-gray-600 hover:text-[#1a73e8]">
              Home
            </Link>
            <Link href="#how-it-works" className="text-gray-600 hover:text-[#1a73e8]">
              How It Works
            </Link>
            <Link href="/locations" className="text-gray-600 hover:text-[#1a73e8]">
              Locations
            </Link>
            <Link href="#" className="text-gray-600 hover:text-[#1a73e8]">
              Contact
        ...
        <div className="container mx-auto px-4">
          <div className="grid grid-cols-1 md:grid-cols-4 gap-8">
            ...
            <div>
              ...
              <ul className="space-y-2">
                <li>
                  <a href="#" className="text-sm hover:text-[#ff6b00]">
                    Terms of Service
                  </a>
                </li>
                <li>
          ...
          <div className="mt-8 pt-8 border-t border-gray-700 text-center">
            <p className="text-sm">
              &copy; {new Date().getFullYear()} Storoo. All rights reserved.
            </p>
          </div>
        </div>
      </footer>
